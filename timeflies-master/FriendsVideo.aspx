<%@ Page Title="" Language="C#" MasterPageFile="~/TimeFlies.master" AutoEventWireup="true"
	CodeFile="FriendsVideo.aspx.cs" Inherits="FriendsVideo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHead" runat="Server">
	...
	<link href="js/selectToUISlider/css/redmond/jquery-ui-1.7.1.custom.css" rel="stylesheet"		type="text/css" />
		<style type="text/css">
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
	<script type="text/javascript">
		...
		$(document).ready(friendsVideoReady);
	</script>
		
		<table align="center" runat="server" id="tblPrivate" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="center">
					<asp:Image runat="server" ID="imgPrivate" ImageUrl="~/images/Private.png" />
				</td>
			</tr>
		</table>
		<asp:Label runat="server" ID="lblmsg"></asp:Label>
		<table border="0" cellpadding="0" cellspacing="0" align="center" runat="server" id="tblVideo">
			<tr>
				<td align="left" style="height: 30px; font-size: 14px;">
					<a href="Friends.aspx">All Friends</a> > <a class="breadcrumb">
						<asp:Label runat="server" ID="lblUserName"></asp:Label></a>
				</td>
			</tr>
			<tr>
				<td align="left" style="height: 510px;" valign="top">
					<div id="divVideo" style="width: 520px;">
